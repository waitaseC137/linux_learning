...
window.READER_DATA = {
  ...
  unit: "parts",
  intro: "Level-by-level walkthroughs of the OverTheWire wargames — <b style=\"color:var(--fg)\">the method is explained, passwords are not shared.</b> Pick a wargame, jump to the level you're on. All readable inside the site.",
  categories: [
    {
    ...
    {
      id: "maze", label: "Maze", accent: "var(--cyan)", tag: "Bonus · 9 levels",
      blurb: "Extra wargame — C++ binaries, vtables and object-oriented exploitation.",
      files: [
