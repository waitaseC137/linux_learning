...
window.READER_DATA = {
  ...
  unit: "bölüm",
  intro: "OverTheWire wargame'lerinin level-by-level çözüm rehberleri — <b style=\"color:var(--fg)\">yöntem anlatılır, şifre paylaşılmaz</b> (Krypton hariç — parola çözümün çıktısıdır). Bir wargame seç, kaldığın level'a git. Hepsi site içinde.",
  categories: [
    {
    ...
    },
    {
      ...
      files: [
        { f: "leviathan/leviathan 0 -> 1.md", n: "0→1", t: "Level 0 → 1", h: "bilgi sızıntısı, grep" },
        { f: "leviathan/leviathan 1 -> 2.md", n: "1→2", t: "Level 1 → 2", h: "ltrace, strcmp" },
        { f: "leviathan/leviathan 2 -> 3.md", n: "2→3", t: "Level 2 → 3", h: "access, argüman bölme" },
        { f: "leviathan/leviathan 3 -> 4.md", n: "3→4", t: "Level 3 → 4", h: "ltrace, gömülü şifre" },
        { f: "leviathan/leviathan 4 -> 5.md", n: "4→5", t: "Level 4 → 5", h: "binary→ASCII çözme" },
        { f: "leviathan/leviathan 5 -> 6.md", n: "5→6", t: "Level 5 → 6", h: "symlink, /tmp yarışı" },
        { f: "leviathan/leviathan 6 -> 7.md", n: "6→7", t: "Level 6 → 7", h: "4-haneli kod, objdump/brute" }
      ]
    },
    {
    ...
    {
      id: "maze", label: "Maze", accent: "var(--cyan)", tag: "Zorluk 5/10 · 9 level",
      blurb: "Karma binary exploitation & RE — TOCTOU, kütüphane hijack, self-modifying kod, FSOP, ELF parser, format string. Capstone.",
      files: [
